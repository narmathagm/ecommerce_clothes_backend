...
let CategoryController = class CategoryController extends tsoa_1.Controller {
    async getAllCategories() {
        return category_service_1.categoryService.getAllCategories();
    }
    async getCategoryById(id) {
        return category_service_1.categoryService.getCategoryById(id);
    }
    async createCategory(body) {
        const result = await category_service_1.categoryService.createCategory(body);
        this.setStatus(result.status);
        return result.data;
    }
    async updateCategory(id, body) {
        const result = await category_service_1.categoryService.updateCategory(id, body);
        this.setStatus(result.status);
        return result.data;
    }
